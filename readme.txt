...
1. An example of the Gutenberg block with a title and description added to the section.
2. An example of the Gutenberg block without a title and description.
3. Configuration options available in the Gutenberg block.
4. Configuration options available in the Widget.
